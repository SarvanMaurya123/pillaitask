        ...
        <>
            <footer className="bg-[#2A2A2A] text-white py-12">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8 px-6 max-w-7xl mx-auto">
                    ...
                    {/* Programmes Section */}
                    <div className="space-y-4">
                        <h2 className="text-lg font-bold  pb-2 inline-block">Programmes</h2>
                        <ul className="space-y-2.5 text-sm">
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Undergraduate Programmes</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Postgraduate Programmes</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Ph.D. Programmes</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Diplomas & Certifications</a></li>
                        </ul>
                    </div>

                    {/* Research Section */}
                    <div className="space-y-4">
                        <h2 className="text-lg font-bold  pb-2 inline-block">Research</h2>
                        <ul className="space-y-2.5 text-sm">
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">CSR</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Equality and Diversity</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Newsletters</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Contact Us</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Admissions</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Life@MIT-WPU</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Happenings</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Alumni</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Work With Us</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Testimonials</a></li>
                        </ul>
                    </div>

                    {/* Social Initiatives Section */}
                    <div className="space-y-4">
                        <h2 className="text-lg font-bold  pb-2 inline-block">Social Initiatives</h2>
                        <ul className="space-y-2.5 text-sm">
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">National Legislators' Conference (NLC) Bharat</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">World Peace Dome</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">World Parliament of Science, Religion & Philosophy</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Bharatiya Chhatra Sansad</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">National Women's Parliament</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">Bharat Asmita National Awards</a></li>
                            <li><a href="#" className=" transition-colors duration-200 hover:translate-x-1 inline-block">National Teachers' Congress (NTC)</a></li>
                        </ul>

                        <div className="mt-6 pt-6 border-t border-gray-700">
                            <h2 className="font-semibold  mb-2"><a href="#" className="">Newsletter Signup</a></h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className=" p-3 rounded-lg text-justify">
                ...
                {/* Bottom Links Bar */}
                <div className="bg-black/60 backdrop-blur-sm w-full mt-8">
